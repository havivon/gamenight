...
ב-**90°**, ולחיצה נוספת מחזירה אותו למצב הרגיל (**0°**).
...
- לחיצה מסובבת את המסך ב-90°, ולחיצה נוספת מחזירה למצב הרגיל (0°).
...
3. לחיצה על הכפתור מסובבת את המסך ב-90°, ולחיצה נוספת מחזירה למצב הרגיל.
